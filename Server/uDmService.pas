...
begin
  FDQuery3.Close;
  FDQuery3.SQL.Clear;
  FDQuery3.SQL.Text := 'select login from usuario where login = :login and senha = :senha';

  FDQuery3.ParamByName('login').AsString := Params.ItemsString['pUsuario'].AsString;
  FDQuery3.ParamByName('senha').AsString := Params.ItemsString['pSenha'].AsString;
